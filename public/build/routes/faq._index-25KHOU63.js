...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/faq._index.jsx"' + id);
  };
...
var Faq = () => {
  ...
  console.log(...oo_oo(`1758078447_31_2_31_26_4`, "faq", faqs));
  const submit = useSubmit();
  const [id, setId] = (0, import_react2.useState)(null);
  const [question, setQuestion] = (0, import_react2.useState)("");
  const [answer, setAnswer] = (0, import_react2.useState)("");
  const [selected, setSelected] = (0, import_react2.useState)("a");
  const handleSelectChange = (0, import_react2.useCallback)((value) => setSelected(value), []);
  const options = [{
    label: "A",
    value: "a"
  }, {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(AppProvider, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Layout, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Layout.Section, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Card, { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button, { onClick: () => {
        setShowModal(true);
        setId(null);
      }, tone: "success", variant: "primary", children: "Add New Faq" }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("table", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("tbody", { children: [
        ...
        faqs == null ? void 0 : faqs.map((item) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("tr", { style: {
          border: 0
        }, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("td", { style: {
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Form, { method: "DELETE", children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("input", { type: "text", hidden: true, name: "id", defaultValue: item.id }, void 0, false, {
                fileName: "app/routes/faq._index.jsx",
                lineNumber: 99,
                columnNumber: 25
              }, this),
              /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Button, { submit: true, tone: "critical", children: "delete" }, void 0, false, {
                fileName: "app/routes/faq._index.jsx",
                lineNumber: 101,
                columnNumber: 25
              }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Layout.Section, { children: showModal && /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(popUpModal_default, { title: id ? "Edit Faq" : "Create Faq", setShowModal, onPrimaryAction: () => {
      submit({
        id,
        question,
        answer,
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(TextField, { label: "Question", type: "text", value: question, autoComplete: "off", onChange: setQuestion }, void 0, false, {
        fileName: "app/routes/faq._index.jsx",
        lineNumber: 126,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(TextField, { label: "Answer", type: "text", value: answer, autoComplete: "off", onChange: setAnswer }, void 0, false, {
        fileName: "app/routes/faq._index.jsx",
        lineNumber: 128,
        columnNumber: 17
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Select, { label: "Date range", options, onChange: handleSelectChange, value: selected }, void 0, false, {
        fileName: "app/routes/faq._index.jsx",
        lineNumber: 130,
        columnNumber: 17
      }, this)
...
_s(Faq, "mdjqlMx5o0GUPvLImW8vkrLNMz4=", false, function() {
  return [useLoaderData, useSubmit];
});
_c = Faq;
var faq_index_default = Faq;
function oo_cm() {
  try {
...
export {
  faq_index_default as default,
  links
};
//# sourceMappingURL=/build/routes/faq._index-25KHOU63.js.map
